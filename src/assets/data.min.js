const identity = { name: "Narpat Aanjana", image: "Profile-pic" };
const data = {
	NavBar: {
		...identity,
		links: [
	...
	Home: {
		introduction:
			"I am a Final year student , i Hvae a interest in design and programming , i know about HTML CSS also know about JS and work as a front end developer.",
		resumeLink: "https://drive.google.com/file/d/19XaqDHE1bYkWYqBH-uDtb06fJw2yIUzV/view?usp=sharing",
		typedElement: [
			"Narpat Aanjana",
			"Web Developer",
			"Web Designer",
	...
	About: {
		...
		about: {
			"tech-stats":
				"Web Developer, Designer, Tech And DevOps Enthusiast",
			bio: "An Enthusiast Developer and Designer Eager to contribute to team success through hard work, skills, attention to details and excellent organizational skills. Currently, Exploring the world of Technology as an intern  at IT Universe. Formerly worked as a Team member at Devsnest for 3 months also working as freelancer Web Developer .",
			"IDE, Editors & Tools": [
				"Adobe Illustrator",
				"Adobe photoshop ",
				"Figma",
		...
		skills: [
			[
				...
				{ skill: "Adobe photoshop", progress: "70" },
				{ skill: "Figma", progress: "90" },
				{ skill: "Wordpress", progress: "90" },
				{ skill: "Design", progress: "90" },
				{ skill: "DSA", progress: "55" },
				{ skill: "Research", progress: "70" },
			],
			[
				{ skill: "C++", progress: "50" },
		...
		education: [
			{
				...
				college:
					"CLG Institute Of Engineering and Technology, Sumerpur 306902",
				duration: "2019 - 2023",
				percentage: "CGPA:8.84",
			},
			{
				animationClass: "Left right",
				textAlignment: "left",
				degree: "XII (Senior Secondary), PCM",
				college: "Saint Meera Sr Sec School, Shivganj (Sirohi)",
			...
			},
			{
				...
				textAlignment: "right",
				degree: "X (Secondary)",
				college: "Lilliput Sec School, Sumerpur (RBSC Board)",
				duration: "Year of Completion : 2017",
				percentage: "Percentage : 76.00%",
			},
		],
	},
	Quote: [
		...
		training: [
			[
				...
				},
				{
					class: "Down",
					title: "HTML",
					subtitle: "Classroom Training - Sololearn",
					...
					link: "https://www.sololearn.com/Certificate/CT-ZIDC8JMK/jpg",
				},
				{
					class: "Right",
	...
	Contact: [
			...
			links: [
				{
					...
					title: "Sumerpur, Rajasthan, India",
				},
			],
		},
		{
		...
		},
		{
			...
			links: [{ type: "mailto:", title: "narpatanjana001@gmail.com" }],
		},
	],
	Social: [
		[
			{
				link: "https://github.com/NarpatAanjana/",
				class: "fab fa-github",
				name: "GitHub",
				placement: "left",
			},
			{
				link: "https://www.linkedin.com/in/narpat-aanjana-84377620b/",
				class: "fab fa-linkedin-in",
				name: "LinkedIn",
				placement: "top",
			},
			/*{
				link: "https://gist.github.com/NarpatAanjana/",
		...
		[
			...
			*/
			{
				link: "https://twitter.com/Narpat0AAnjana/",
